...
### Fixed
- **2025-08-15**: Admin authentication — Fixed "Access token required" popup by adding Bearer token headers to fetchJson in app/frontend/src/lib/http.ts and auth validation in AdminPage. Admin requests now include proper authentication.
